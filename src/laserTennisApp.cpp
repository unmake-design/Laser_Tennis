#include "laserTennisApp.h"
#include "ofxIldaFrame.h"

//--------------------------------------------------------------
void laserTennisApp::setup(){
    ofBackground(100);
...
//--------------------------------------------------------------
void laserTennisApp::mouseMoved(int x, int y){
...
//---------------------------------------------------------------
void laserTennisApp::keyReleased(int key){
    switch (mode) {
        case 0:
            mode = 1;
            break;
...
//----------------------------------------------------------------
ofPoint laserTennisApp::ildaTranslate(ofPoint point){
...
//----------------------------------------------------------------
vector <ofPoint> laserTennisApp::ildaTranslate(vector <ofPoint> points){
...
// ---------------------------------------------------------------
vector<ofPoint> laserTennisApp::getLetterDrawPoints(vector<ofPoint> letter, int xMove, int yMove){
...
// ---------------------------------------------------------------
vector<ofPoint> laserTennisApp::scaleLetter(vector<ofPoint> letter, int scaleFactor){
    for (int i = 0; i < letter.size(); i++){
...
// ---------------------------------------------------------------
vector<ofPoint> laserTennisApp::getScoreVector(int score){
